...
\TheProperty[mail:postfix:install_command]{install\_\\command}
\TheProperty*[mail!postfix!install\_command]{install\_command \Arg{command}}
...
\TheProperty[mail:postfix:restart_command]{restart\_\\command}
\TheProperty*[mail!postfix!restart\_command]{restart\_command \Arg{command}}

The \Arg{command} to reload the postfix service. Can be a full path or
just the command name that can be found in the current search path.
For the distribution
\begin{inparaitem}
\item[\TheDistribution{ubuntu}] Ubuntu 10.04
...
\TheProperty[mail:postfix:alias_domains_file]{alias\_domains\_file}
...
%% mailbox_maps_file
\TheProperty[mail:postfix:mailbox_maps_file]{mailbox\_maps\_file}
...
\TheProperty[mail:postfix:mailbox_base_directory]{mailbox\_base\_directory}

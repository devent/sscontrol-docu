...
\TheProperty[database:mysql:default_debug_logging]{default\_debug\_\\logging}
\TheProperty*[database!mysql!default\_debug\_logging]{default\_debug\_logging \Arg{level}}

The default debug logging \Arg{level}.
For the distribution
\begin{inparaitem}
\item[\TheDistribution{ubuntu}] Ubuntu 10.04
\end{inparaitem}

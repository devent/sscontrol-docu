...
\TheStatement[bind_address]{bind\_address}
...
\TheStatement[admin_password]{admin\_password}
...
\TheStatement[import_sql]{import\_sql}
...
\TheStatement{user}
\TheStatement*{user \Arg{name}, password: \Arg{password} [, server: \Arg{host}] [, \{ use\_database \}]}

...
\TheProperty*[database!mysqladmin\_command]{mysqladmin\_command \Arg{name}}
...
\TheProperty*[database!mysql\_command]{mysql\_command \Arg{name}}
...
\TheProperty*[database!configuration\_directory]{configuration\_directory \Arg{path}}
...
\TheProperty*[database!mysqld\_configuration\_file]{mysqld\_configuration\_file \Arg{name}}
...
\TheProperty*[database!packages]{packages \Arg{packages}}
...
\TheProperty*[database!restart\_services]{restart\_services \Arg{services}}
...
\TheProperty*[database!default\_character\_set]{default\_character\_set \Arg{name}}
...
\TheProperty*[database!default\_collate]{default\_collate \Arg{name}}
